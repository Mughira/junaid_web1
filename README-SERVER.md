...
3. **Open your browser**: `http://localhost:8000/Kingship Transportations.html`

### Manual Start
1. Open PowerShell or Command Prompt in this folder
2. Run: `node server.js`
3. Open: `http://localhost:8000/Kingship Transportations.html`
